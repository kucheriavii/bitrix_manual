...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="CUtil::CetAdditionalFileURL(SITE_TEMPLATE_PATH."/js/vendor/modernizr-html5shiv-respond.min.js")"></script>
    <![endif]-->
    <!--[if gte IE 9]><!-->
    <script src="CUtil::CetAdditionalFileURL(SITE_TEMPLATE_PATH."/js/vendor/modernizr.min.js")"></script>
    <!--<![endif]-->
</head>
<body>
    <!--[if lt IE 8]>
